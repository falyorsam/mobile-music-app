...
------------------nav-------------------
![screenshot](songPage/songPage-1.png)
```html
   <nav class="nav-5">
              <!-- insideToClick  -->
...
```
------------------suggested--------------------
![screenshot](sugg-page-1/sugg-page-1-1.png)
![screenshot](sugg-page-2/sugg-page-2-1.png)
```html
...
```
------------------albums--------------------
![screenshot](artist/artist-1.png)
```html
<div class="page" id="page3">
  <div class="container">
        ...
        <div class="OneMusic">
              <div class="musicImg">
                <img class="MusicImg" src="https://picsum.photos/200" width="160px" alt="musicImg">
              </div>
              <div class="MusicText">
                <div class="songName SSSS"> je te lasserai des mots</div>
                <div class="songInfo">casmas linx</div>
...
![screenshot](create-somgthing-new/playlist-1/playlist-1-1.png)
![screenshot](create-somgthing-new/playlist-2/playlist-2-1.png)
      ...
      <div class="playlistSec">
        <div class="playText">
          ...
          <div class="createP">
            ...
            <div class="JustifyIcon"> <div class="createPlaylist">
              <i class="fa-solid fa-plus"></i>
              Create Playlist
            </div>
          </div>
...
<div class="page" id="page6">
 ...
 <i class="fa-solid fa-folder-open"></i>
      ...
      <div class="oneFolder">
       <div class="insinde"> <i class="fa-solid fa-folder-minus"></i>
        block 
